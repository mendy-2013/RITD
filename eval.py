...
def main():
    ...
    parser.add_argument('--exp', default="MPSC_resnet50_deform_thre_asf.yaml",type=str)
    parser.add_argument('--batch_size', type=int,
                        help='Batch size for training')
    # parser.add_argument('--resume', type=str, help='Resume from checkpoint')
    parser.add_argument('--resume',default="outputs/workspace/DB-master/SegDetectorModel-seg_detector/deformable_resnet50/L1BalanceCELoss/model/model_epoch_0_minibatch_5", type=str, help='Resume from checkpoint')
    parser.add_argument('--result_dir', type=str, default='./results1/', help='path to save results')
