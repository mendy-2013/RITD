...
class snake_conv_block(nn.Module):
    # Differential_block with 2 convolutions
    def __init__(self, in_channels, out_channels, n = 0, kernel_size=3, stride = 1, padding = None, act = True, e = 2):
        super(snake_conv_block,self).__init__()
        ...
        # snake_conv 
        self.snake_conv = DSConv(out_channels,
                                self.mid,      #偶数(//4) 对4取整
                                kernel_size=5,
                                extend_scope=1,
                                morph=0,
